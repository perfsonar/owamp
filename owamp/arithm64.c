 ...
 *         representation. These are "relative" time values.
 *         (Not absolutes - i.e. they are not relative to some "epoch".)
 *         OWPNum64 values are unsigned 64 integral types with the
 *         Most Significant 32 of those 64 bits representing seconds.
 *         The Least Significant 32 bits represent fractional seconds at
